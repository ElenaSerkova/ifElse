...
public class String03 {
    public static void main(String[] args) {
        ...
        System.out.println(" ====== получение символа из строки по его по индексу   =====");
        ...
        System.out.println(" ====== либо от одного индекса до другого  =====");
        System.out.println(" ====== либо от одного до конца строки  =====");
